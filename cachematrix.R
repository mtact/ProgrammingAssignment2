## The overall goal of the following functions is to cache the value of the matrix inverse so that when we need it again, it can be looked up in the cache rather than recomputed.
